...
function (_Component) {
  ...
  function Home(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleCharacterCardClick", function (name) {
      _this.setState({
        selectedCharacter: name
      });

      console.log(_this.state.selectedCharacter); // fetch films that character has been in
      // update films state
    });
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Container, {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_styled_flexboxgrid__WEBPACK_IMPORTED_MODULE_1__["Col"], {
          ...
          onClick: function onClick() {
            return handleCharacterCardClick(char.name);
          },
          __source: {
            fileName: _jsxFileName,
            lineNumber: 82
...
//# sourceMappingURL=home.js.96e42af449d09a0044a4.hot-update.js.map