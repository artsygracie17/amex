...
var _this = undefined,
    _jsxFileName = "/Users/gracieliu-fang/Code/amex/pages/home.js";
...
var Name = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].p(_templateObject3(), function (props) {
  return props.currentCharacter === _this.state.selectedCharacter ? 'black' : 'gray';
});
...
function (_Component) {
  ...
  function Home(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this2)), "handleCharacterNameClick", function (name, reqUrl) {
      _this2.setState({
        films: [],
        selectedCharacter: name
      });

      _this2.fetchFilms(reqUrl);
    });
                ...
                fetch(reqUrl).then(function (res) {
                  ...
                  filmUrls && filmUrls.map(function (url) {
                    fetch(url).then(function (res) {
                      ...
                      _this3.setState({
                        films: _toConsumableArray(_this3.state.films).concat([filmData])
                      });
                    });
                  });
                });
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container, {
        ...
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_styled_flexboxgrid__WEBPACK_IMPORTED_MODULE_2__["Col"], {
          ...
          isCurrentCharacter: char.name === _this4.state.selectedCharacter,
          __source: {
            fileName: _jsxFileName,
            lineNumber: 88
          },
...
//# sourceMappingURL=home.js.ac4c3edf76ffd71f3d08.hot-update.js.map