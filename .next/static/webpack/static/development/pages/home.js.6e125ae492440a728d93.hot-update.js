...
var EmptyState = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].p(_templateObject6());
...
function (_Component) {
  ...
  _createClass(Home, [{
            ...
            switch (_context.prev = _context.next) {
              case 0:
                fetch(reqUrl).then(function (res) {
                  ...
                  console.log('films before: ', _this2.state.films);

                  _this2.setState({
                    films: _this2.state.films.sort(function (a, b) {
                      a.title - b.title;
                      console.log('films: ', _this2.state.films);
                    }),
                    status: 'SETTLED'
                  });

                  console.log('films after: ', _this2.state.films);
    ...
    value: function render() {
      console.log('films after: ', this.state.films);
...
//# sourceMappingURL=home.js.6e125ae492440a728d93.hot-update.js.map